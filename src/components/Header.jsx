          ...
          >
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                ...
                <MobileNavItem href="/projects">Lab</MobileNavItem>
                <MobileNavItem href="/articles">Writing</MobileNavItem>
                <MobileNavItem href="/adventures">Photography</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/projects">Lab</NavItem>
        <NavItem href="/articles">Writing</NavItem>
        <NavItem href="/adventures">Photography</NavItem>
        {/* 
...
function ModeToggle() {
  ...
  return (
    ...
    >
      ...
      <MoonIcon className="hidden h-6 w-6 fill-zinc-700 stroke-zinc-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-zinc-400 [@media_not_(prefers-color-scheme:dark)]:fill-red-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-red-500" />
    </button>
  )
}
